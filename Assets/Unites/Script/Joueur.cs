...
public class Joueur
{
    ...
    public void addressources(int ress){
        this.ressources=this.ressources+ress;
    }



 public Joueur(string nom, PlayerColor couleur) //Le constructeur 
    {
        this.nom = nom;
        this.couleur = couleur;
        ...
        this.ressources = 1000; // Exmple de Valeur par défaut
    }
